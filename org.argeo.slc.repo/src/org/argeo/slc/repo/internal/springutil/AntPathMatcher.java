...
package org.argeo.slc.repo.internal.springutil;
...
//		String[] pathDirs = StringUtils.tokenizeToStringArray(path, this.pathSeparator);
	 ...
	 * '<code>/docs/cvs/commit.html</code> to ''</li>
	 * <li>'<code>/docs/*</code>' and '<code>/docs/cvs/commit</code> to
	 * '<code>cvs/commit</code>'</li>
	 * <li>'<code>/docs/cvs/*.html</code>' and '<code>/docs/cvs/commit.html</code>
	 * to '<code>commit.html</code>'</li>
	 * <li>'<code>/docs/**</code>' and '<code>/docs/cvs/commit</code> to
	 * '<code>cvs/commit</code>'</li>
	 * <li>'<code>/docs/**\/*.html</code>' and '<code>/docs/cvs/commit.html</code>
	 * to '<code>cvs/commit.html</code>'</li>
	 * <li>'<code>/*.html</code>' and '<code>/docs/cvs/commit.html</code> to
	 * '<code>docs/cvs/commit.html</code>'</li>
	 * <li>'<code>*.html</code>' and '<code>/docs/cvs/commit.html</code> to
	 * '<code>/docs/cvs/commit.html</code>'</li>
	 * <li>'<code>*</code>' and '<code>/docs/cvs/commit.html</code> to
	 * '<code>/docs/cvs/commit.html</code>'</li>
	 * </ul>
	 * <p>
	 * Assumes that {@link #match} returns <code>true</code> for
	 * '<code>pattern</code>' and '<code>path</code>', but does <strong>not</strong>
	 * enforce this.
	 */
