...
/**
 * Execution Flow calling a list of <code>Runnable</code> (identified by their bean 
...
public class RunnableCallFlow implements ExecutionFlow, ApplicationContextAware {
	...
	/**
	 * Whether an exception in a <code>Runnable</code> shall
	 * stop the execution of the flow
	 */
	private Boolean failOnError = true;	
		
	/**
	 * List of <code>Runnable</code> to call, with bean name, execution variables and 
	 * context values
	 */
	...
	/**
	 * Reference to the Spring <code>ApplicationContext</code>.
	 * Set via <code>setApplicationContext</code>, the class implementing
	 * <code>ApplicationContextAware</code>
	 */
	private ApplicationContext applicationContext;
	
	/**
	 * Runs a <code>Runnable</code> after configuring the Execution Context 
	 * and <code>sharedContextValuesMap</code>
	 * @param runnable the <code>Runnable</code> to call
	 * @param executionVariables the variables to add to the <code>ExecutionContext</code>
	 * @param contextValues the variables to add to <code>sharedContextValuesMap</code>
	 * @param callIndex index of the call (0 for the first called <code>Runnable</code>)
	 * set as variable of the <code>ExecutionContext</code>
	 */
	private void run(Runnable runnable, Map<String, Object> executionVariables, Map<String, Object> contextValues, int callIndex) {
	...
	/**
	 * Executes the flow. 
	 * For each <code>RunnableCall</code>, the corresponding flow
	 * is retrieved from the Spring Application Context, the 
	 * <code>ExecutionContext</code> and <code>sharedContextValuesMap</code>
	 * are configured and the <code>Runnable</code> is called.
	 */
	public void run() {
